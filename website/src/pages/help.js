...
function Help() {
  ...
  const supportLinks = [
    ...
    {
      content: '[Ask questions](https://github.com/luitjens-test-gh-app/workflow-tests/issues) about the documentation and project',
      title: 'Join the community',
    },
    {
      content: '[Find out](https://github.com/luitjens-test-gh-app/workflow-tests/releases) what\'s new with this project',
